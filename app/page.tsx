      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6 pt-20">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-12">
          ...
          >
            ...
            <div className="relative bg-black px-8 py-4 rounded-sm flex items-center justify-center gap-2 border border-amber-700/50 group-hover:border-amber-600 transition-colors text-orange-500">
              EXPLORE EVENTS
